...
def get_colors(file, contaimagens=0):
	...
	row = file+","+str(p_black)+","+str(p_red)+","+str(p_green)+","+str(p_blue)+","+str(p_yellow)+","+str(p_magenta)+","+str(p_cyan)+","+str(p_maroon)+","+str(p_purple)+","+str(p_orange)+","+str(p_gray)+","+str(p_white)+"\n"
	return row


csv = []	#cria array para csv saida
saida= open("saida3.csv", "w")
